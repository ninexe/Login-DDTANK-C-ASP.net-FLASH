...
function user_ZingPay(ProductID,AccountName,ServerID,UserID){
	...
	HomeDiv.style.width = "752px";
	HomeDiv.style.height = "402px";
	HomeDiv.style.position = "absolute";
	HomeDiv.style.left = (jQuery(window).width() - 752) / 2 + "px";
	...
	CloseLink.style.background = "url(./launcher/images/ZingPayClose.png) no-repeat";
	...
	centerIframePay.style.width = "752px";
	centerIframePay.style.height = "378px";
	//centerIframePay.style.position = "absolute";
	centerIframePay.src = "./launcher/topup.htm?pid=" +ProductID +"&acc="+ AccountName+"&serid="+ ServerID+"&uin="+UserID;
